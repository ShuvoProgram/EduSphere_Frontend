...
const Banner = () => {
  ...
  return (
    <div className="banner-area bg-1">
            ...
            >
              ...
              <div className="flex mr-2">
                {[1, 2, 3].map((index) => (
                  <img
                    key={index}
                    className="border-2 border-white rounded-full h-10 w-10 -mr-3"
      ...
      <img src="/assets/images/banner/shape-1.svg" className="shape shape-1" alt="banner" />
      <img src="/assets/images/banner/shape-2.svg" className="shape shape-2" alt="banner" />
      <img src="/assets/images/banner/shape-3.svg" className="shape shape-3" alt="banner" />
    </div>
  );
};
