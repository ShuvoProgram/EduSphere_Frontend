...
import Achieve from '../../../../../public/assets/images/achievement.png';
    ...
    <section className='w-full bg-white p-5'>
        <div className='md:max-w-[1100px] m-auto grid md:grid-cols-2 max-w-[400px]'>
            <div className='flex flex-col justify-start gap-4'>
                <h1 className='md:leading-[42px] py-2 text-3xl font-semibold text-black'>
                ...
                <div className='grid md:grid-cols-2 grid-cols-1'>
                    <div className="py-6 flex">
                        ...
                        <div className='px-3'>
                            <h1 className='text-2xl font-semibold text-black'>100 +</h1>
                    ...
                    <div className="py-6 flex">
                        ...
                        <div className='px-3'>
                            <h1 className='text-2xl font-semibold text-black'>10,000 +</h1>
                    ...
                    <div className="py-6 flex">
                        ...
                        <div className='px-3'>
                            <h1 className='text-2xl font-semibold text-black'>3000 +</h1>
                    ...
                    <div className="py-6 flex">
                        ...
                        <div className='px-3'>
                            <h1 className='text-2xl font-semibold text-black'>300 +</h1>
            ...
            <div className="justify-center items-center">
                <Image width={350} height={400} src={Achieve} alt="hero" className='md:order-last m-auto order-first'/>
            </div>
        </div>
    </section>
  )
