...
export const CourseCard2 = ({ course, isProfile }: Props) => {
    ...
    return (
        ...
        >
        <div className="w-[300px] h-[320px] card">
            <div className="h-[320px] top-0 w-[300px] left-0">
                <div className="relative w-[300px] h-[396px]">
                    <div className="absolute h-[320px] top-[15px] bg-white rounded-[8px] shadow-[0px_20px_40px_#b7bcc840] w-[300px] left-0" />
                    ...
                    <div className="absolute w-[300px] h-[16px] top-[300px] left-[25px]">
                    ...
                    <div className="absolute w-[300px] h-[180px] top-[160px] left-0">
                       ...
                       <Image
                        ...
                        <Link href={`${isProfile ? `/course-access/${course?._id}` : `/course/${course?._id}`
                            }`} className="absolute w-[300px] top-[68px] left-[15px] [font-family:'Inter-Bold',Helvetica] font-bold text-[#1a2134] text-[16px] tracking-[0] leading-[26px] hover:text-teal-600">
                            {course?.name}
                        </Link>
                        <div className="w-[94px] left-[15px] absolute h-[32px] top-[100px]">
                        ...
                        <div className="w-[56px] left-[138px] absolute h-[32px] top-[100px]">
                            <div className="absolute w-[32px] h-[32px] top-0 left-0 bg-white rounded-[16px] border border-solid border-[#e6e7ee]">
                                <Image
                                    width={16}
                                    height={16}
                        ...
                        <div className="w-[61px] left-[224px] absolute h-[32px] top-[100px]">
                            <div className="absolute w-[32px] h-[32px] top-0 left-0 bg-white rounded-[16px] border border-solid border-[#e6e7ee]">
