...
const DashboardHeader = () => {
  ...
  return (
    <div className="w-full flex items-center justify-end p-6 fixed top-0 right-0 z-[39]  bg-white ">
      <ThemeSwitcher />
      ...
      {open && (
        <div
          ref={notificationRef}
          className="w-[350px] h-[50vh]  bg-white shadow-xl absolute top-16 z-[100000000] rounded overflow-y-scroll overflow-x-hidden"
        >
          <h5 className="text-center text-[20px] font-Poppins text-black p-3 sticky top-0 w-full bg-white ">
            Notifications
          </h5>
          {notifications.length > 0 &&
            notifications?.map((notification: any) => (
              <div
                ...
                className=" bg-[#00000013] font-Poppins border-b  border-b-[#0000000f] mt-1"
              >
                ...
                <p className="p-2 text-gray-400  text-[14px]">
